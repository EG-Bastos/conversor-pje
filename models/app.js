...
function converte() {
    fs.writeFileSync('saida/eduardo.xlsx', xlseduardo, 'binary');
    fs.writeFileSync('saida/alan.xlsx', xlsalan, 'binary');
    fs.writeFileSync('saida/alessandra.xlsx', xlsalessandra, 'binary');
    fs.writeFileSync('saida/carmem.xlsx', xlscarmem, 'binary');
